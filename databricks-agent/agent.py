...
PROMPT="""You are a helpful assistant that can answer questions about travel data.
    ...
    - `sg_demo.bakehouse.sales_franchises`: The table contains information about franchise locations, including details such as the franchise ID, name, and geographical data like city, district, zipcode, country, and coordinates (longitude and latitude). This data can be used for analyzing franchise distribution, assessing market coverage, and identifying potential areas for expansion or improvement.
